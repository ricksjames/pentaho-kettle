...
public abstract class BaseStreamStepMeta extends StepWithMappingMeta implements StepMetaInterface, ISubTransAwareMeta {
  ...
  public static final String PREFETCH_DEFAULT = Integer.toString( 100000 );
    ...
    try {
      ...
      if ( prefetch <= 0 ) {
        remarks.add( new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR,
          BaseMessages.getString( PKG, "BaseStreamStepMeta.CheckResult.PrefetchGreaterThanZero", prefetch, size ),
          stepMeta ) );
      }

      if ( prefetch <= size ) {
        remarks.add( new CheckResult( CheckResultInterface.TYPE_RESULT_ERROR,
          BaseMessages.getString( PKG, "BaseStreamStepMeta.CheckResult.PrefetchGreaterThanBatch", prefetch, size ),
          stepMeta ) );
      }
    } catch ( NumberFormatException e ) {
      remarks.add( new CheckResult(
