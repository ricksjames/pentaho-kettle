...
public class BaseStreamStepMetaTest {
  ...
  public void testCheckLessThanBatch() {
    ...
    assertEquals( 1, remarks.size() );
    assertEquals( CheckResultInterface.TYPE_RESULT_ERROR, remarks.get( 0 ).getType() );
    assertEquals( "The \"Message prefetch count\" must be greater than the \"Number of records\". 1 is not greater than 2",
      remarks.get( 0 ).getText() );
  }
  ...
  public void testCheckPrefetchZero() {
    ...
    assertEquals( "The \"Message prefetch count\" must be greater than 0. 0 is not greater than 0",
      remarks.get( 0 ).getText() );
    assertEquals( CheckResultInterface.TYPE_RESULT_ERROR, remarks.get( 1 ).getType() );
    assertEquals( "The \"Message prefetch count\" must be greater than the \"Number of records\". 0 is not greater "
        + "than 1000",
      remarks.get( 1 ).getText() );
  }
