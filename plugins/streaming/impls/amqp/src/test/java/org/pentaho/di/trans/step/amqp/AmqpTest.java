...
public class AmqpTest {
  ...
  /**
   * This test throws an exception because default exchanges don't allow binding of default exchange queues to
   * routing keys
   * during consumption
   *
   * @throws Exception
  ...
  public void testFanoutRoundRobin() throws IOException, InterruptedException {
    ...
    List<String> consumer0ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, queue, Collections.singletonList( queue ) );
    List<String> consumer1ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, queue, Collections.singletonList( queue ) );
  ...
  public void testFanoutFairTempQueue() throws IOException, InterruptedException {
    ...
    List<String> consumer0ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, null, Collections.singletonList( queue ), false );
    List<String> consumer1ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, null, Collections.singletonList( queue ), false );
  ...
  public void testFanoutPrefetch() throws IOException, InterruptedException {
    ...
    List<String> consumer0ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, queue, Collections.singletonList( queue ), false );
    List<String> consumer1ReceivedMessages =
      consume( FANOUT_EXCHANGE, FANOUT_TYPE, queue, Collections.singletonList( queue ), false );
  ...
  public void testTopic() throws IOException, InterruptedException {
    List<String> consumer0ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "*.*.*" ) ) );
    List<String> consumer1ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "#" ) ) );
    List<String> consumer2ReceivedMessages = consume( TOPIC_EXCHANGE, TOPIC_TYPE, null,
      new ArrayList<>( Arrays.asList( "abc.def.ghi", "jkl.mno.pqr", "stu.vwx.yz" ) ) );
    List<String> consumer3ReceivedMessages = consume( TOPIC_EXCHANGE, TOPIC_TYPE, null,
      new ArrayList<>( Arrays.asList( "*.def.ghi", "jkl.*.pqr", "stu.vwx.*" ) ) );
    List<String> consumer4ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.#", "jkl.#", "stu.#" ) ) );

    List<String> consumer5ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.def.ghi" ) ) );
    List<String> consumer6ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "*.def.ghi" ) ) );
    List<String> consumer7ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.*.ghi" ) ) );
    List<String> consumer8ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.*.*" ) ) );
    List<String> consumer9ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.def.*" ) ) );
    List<String> consumer10ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.#" ) ) );
    List<String> consumer11ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "#.def.ghi" ) ) );
    List<String> consumer12ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.#.ghi" ) ) );
    List<String> consumer13ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.def.#" ) ) );
    List<String> consumer14ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "#.abc.def.ghi" ) ) );
    List<String> consumer15ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, null, new ArrayList<>( Arrays.asList( "abc.def.ghi.#" ) ) );


    List<String> firstTopicMessages =
      Arrays.asList( "abc.def.ghi message1", "abc.def.ghi message2", "abc.def.ghi message3" );
  ...
  public void testDirectWithWildcards() throws IOException, InterruptedException {
    List<String> consumer0ReceivedMessages =
      consume( DIRECT_EXCHANGE, DIRECT_TYPE, null, new ArrayList<>( Arrays.asList( "ajkl.mno.pqr" ) ) );
  ...
  public void testTopicNamedQueueProduceFirstSecondTime() throws IOException, InterruptedException, TimeoutException {
    ...
    List<String> consumer0ReceivedMessages =
      consume( TOPIC_EXCHANGE, TOPIC_TYPE, queue, new ArrayList<>( Arrays.asList( "*.*.*" ) ) );
  ...
  /**
   * Note: Producer routingKey cannot be null, but beyond that when in header mode the queue and routingKey are
   * ignored
  ...
  private void produce( String exchange, String exchangeType, String routingKey, List<String> messages )
    throws IOException {
  ...
  private void produce( String exchange, String exchangeType, String routingKey, List<String> messages, boolean durable,
  ...
  private List<String> consume( String exchange, String exchangeType, String queue, boolean autoAck )
    throws IOException {
    return consume( exchange, exchangeType, queue, null, autoAck, true, false, false, null );
  }

  private List<String> consume( String exchange, String exchangeType, String queue, List<String> routingKeys )
    throws IOException {
    return consume( exchange, exchangeType, queue, routingKeys, true, true, false, false, null );
  }

  private List<String> consume( String exchange, String exchangeType, String queue, Map<String, Object> arguments )
    throws IOException {
  ...
  private List<String> consume( String exchange, String exchangeType, String queue, List<String> routingKeys,
                                final boolean autoAck, boolean durable, boolean exclusive, boolean autoDelete,
                                Map<String, Object> arguments ) throws IOException {
